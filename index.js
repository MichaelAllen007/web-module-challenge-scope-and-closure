...
/*Task 1: counterMaker()
  ...
  Counter 1 will remember the the number. Counter 2 will not.
  2. Which of the two uses a closure? How can you tell?
  Counter 1 is the closure because there is a function inside the function
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     counter 1 is better for more long term settings, counter 2 is good if all it has to do is count runs
*/
